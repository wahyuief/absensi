...
class Absensi_model extends CI_Model
{
    ...
    {
        $this->db->select('absensi.id_absensi, absensi.tanggal_absen, absensi.foto, absensi.latitude, absensi.longitude, absensi.keterangan, mata_kuliah.nama_matkul, mata_kuliah.sks, users.*');
