        ...
        <div class="card">
          <div class="card-header">
              <div class="card-title">
                <a href="<?php echo base_url('kelas/add'); ?>" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add New</a>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" role="menu" style="">
                      <a class="dropdown-item" href="<?php echo base_url('kelas/export_pdf'); ?>">PDF</a>
                      <a class="dropdown-item" href="<?php echo base_url('kelas/export_excel'); ?>">Excel</a>
                    </div>
                  </div>
              </div>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu" style="">
                            <a class="dropdown-item" href="<?php echo base_url('kelas/edit/' . wah_encode($data->id_kelas)); ?>">Edit</a>
                            <a class="dropdown-item" data-toggle="confirmation" data-title="Are you sure want to delete?" data-placement="left" href="<?php echo base_url('kelas/delete/' . wah_encode($data->id_kelas)); ?>">Delete</a>
                          </div>
                        </div>
                      </td>
                  </tr>
