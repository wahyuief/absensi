        ...
        <div class="card">
          <div class="card-header">
              <div class="card-title">
                <a href="<?php echo base_url('kelas/mahasiswa/add/' . $this->uri->segment(3)); ?>" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add New</a>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" role="menu" style="">
                      <a class="dropdown-item" href="<?php echo base_url('kelas/mahasiswa/export_pdf'); ?>">PDF</a>
                      <a class="dropdown-item" href="<?php echo base_url('kelas/mahasiswa/export_excel'); ?>">Excel</a>
                    </div>
                  </div>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu" style="">
                            <a class="dropdown-item" href="<?php echo base_url('kelas/mahasiswa/edit/' . wah_encode($data->id_km)); ?>">Edit</a>
                            <a class="dropdown-item" data-toggle="confirmation" data-title="Are you sure want to delete?" data-placement="left" href="<?php echo base_url('kelas/mahasiswa/delete/' . wah_encode($data->id_km)); ?>">Delete</a>
                          </div>
                        </div>
                      </td>
                  </tr>
