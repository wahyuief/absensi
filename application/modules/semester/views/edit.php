      ...
      <div class="container-fluid">
            <div class="card">
                  ...
                  <div class="card-body rounded login-card-body">
                        ...
                        <div class="row mb-3">
                              ...
                              <div class="col-sm-8 input-group">
                                    <input type="text" name="tahun" id="tahun" value="<?php echo $this->form_validation->set_value('tahun', $data->tahun); ?>" class="form-control" autofocus required>
                        ...
                        <div class="row mb-3">
                              ...
                              <div class="col-sm-8 input-group">
                                    <input type="text" name="keterangan" id="keterangan" value="<?php echo $this->form_validation->set_value('keterangan', $data->keterangan); ?>" class="form-control" required>
                                    <div class="input-group-append">
                  ...
                  <div class="card-footer border-top">
                        <?php echo form_hidden('id', wah_encode($data->id_semester));?>
