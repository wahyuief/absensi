      ...
      <div class="container-fluid">
            <div class="card">
                  ...
                  <div class="card-body rounded login-card-body">
                        <div class="row mb-3">
                              <label for="nik" class="col-sm-2 form-label wahlabel">NIDN</label>
                        ...
                        <div class="row mb-3">
                              ...
                              <label for="user" class="col-sm-2 form-label wahlabel">Nama Dosen</label>
                              <div class="col-sm-8 input-group">
...
<script>
      ...
      function simpanfoto(str) {
            ...
            $.ajax({
                  ...
                  url: "<?php echo base_url('dosen/foto/upload') ?>",
