        ...
        <div class="card">
          <div class="card-header">
              <div class="card-title">
                <a href="<?php echo base_url('administrator/users/add'); ?>" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add New</a>
                  <div class="btn-group">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td><?php foreach ($user->groups as $group) { echo '<span class="badge bg-primary">' . $group->name . '</span> '; } ?></td>
