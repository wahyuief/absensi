...
class Mahasiswa extends BackendController {
	...
	{
		$this->data['total'] = $this->ion_auth->like('fullname', input_get('q'))->users('mahasiswa')->num_rows();
		...
		$this->data['end'] = ($this->data['total'] > 0 ? $this->data['pagination']->offset+$this->ion_auth->like('fullname', input_get('q'))->limit($this->data['pagination']->limit)->offset($this->data['pagination']->offset)->users('mahasiswa')->num_rows() : 0);
		$this->data['users'] = $this->ion_auth->like('fullname', input_get('q'))->limit($this->data['pagination']->limit)->offset($this->data['pagination']->offset)->order_by('id', 'DESC')->users('mahasiswa')->result();
