        ...
        <div class="card">
          <div class="card-header">
              <div class="card-title">
                <a href="<?php echo base_url('mahasiswa/add'); ?>" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add New</a>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" role="menu" style="">
                      <a class="dropdown-item" href="<?php echo base_url('mahasiswa/export_pdf'); ?>">PDF</a>
                      <a class="dropdown-item" href="<?php echo base_url('mahasiswa/export_excel'); ?>">Excel</a>
                    </div>
                  </div>
              </div>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu" style="">
                            <a class="dropdown-item" href="<?php echo base_url('mahasiswa/edit/' . wah_encode($user->id)); ?>">Edit</a>
                            <?php if($user->id !== '1'): ?><a class="dropdown-item" data-toggle="confirmation" data-title="Are you sure want to delete?" data-placement="left" href="<?php echo base_url('mahasiswa/delete/' . wah_encode($user->id)); ?>">Delete</a><?php endif; ?>
                          </div>
                        </div>
                      </td>
                  </tr>
