      ...
      <div class="container-fluid">
            <div class="card">
                  ...
                  <div class="card-body rounded login-card-body">
                        ...
                        <div class="row mb-3">
                              ...
                              <div class="col-sm-8 input-group">
                                    <input type="text" name="nama_matkul" id="nama_matkul" value="<?php echo $this->form_validation->set_value('nama_matkul', $data->nama_matkul); ?>" class="form-control" autofocus required>
                        ...
                        <div class="row mb-3">
                              ...
                              <div class="col-sm-8 input-group">
                                    <input type="number" name="sks" id="sks" value="<?php echo $this->form_validation->set_value('sks', $data->sks); ?>" class="form-control" autofocus required>
                                    <div class="input-group-append">
                                          <div class="input-group-text"><i class="fas fa-book-bookmark"></i></div>
                                    </div>
                              </div>
                              ...
                              <div class="col-sm-8 input-group">
                                    <select name="dosen" id="dosen" class="form-control" required>
                                          ...
                                          <?php foreach($dosen as $dsn): ?>
                                                <option <?php echo($data->id_dosen === $dsn->id ? 'selected' : '') ?> value="<?php echo $dsn->id ?>"><?php echo $dsn->fullname ?></option>
                                          <?php endforeach; ?>
                                    </select>
                                    <div class="input-group-append">
                              ...
                              <div class="col-sm-8 input-group">
                                    <select name="semester" id="semester" class="form-control" required>
                                          ...
                                          <?php foreach($semester as $smstr): ?>
                                                <option <?php echo($data->id_semester === $smstr->id_semester ? 'selected' : '') ?> value="<?php echo $smstr->id_semester ?>"><?php echo $smstr->tahun . ' ' . $smstr->keterangan ?></option>
                                          <?php endforeach; ?>
                                    </select>
                                    <div class="input-group-append">
                  ...
                  <div class="card-footer border-top">
                        <?php echo form_hidden('id', wah_encode($data->id_matkul));?>
